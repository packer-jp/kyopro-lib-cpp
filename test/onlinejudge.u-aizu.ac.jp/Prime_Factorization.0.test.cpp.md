...
data:
  ...
  bundledCode: "#line 1 \"test/onlinejudge.u-aizu.ac.jp/Prime_Factorization.0.test.cpp\"\
    ...
    \    for (V i = 2; i * i <= n; ++i) {\n        while (n % i == 0) {\n        \
    \    ret.push_back(i);\n            n /= i;\n        }\n    }\n    if (n != 1)\
    \ ret.push_back(n);\n    return ret;\n}\n#line 3 \"test/onlinejudge.u-aizu.ac.jp/Prime_Factorization.0.test.cpp\"\
    \n\n#line 5 \"test/onlinejudge.u-aizu.ac.jp/Prime_Factorization.0.test.cpp\"\n\
    using namespace std;\n\nint main() {\n    ll n;\n    cin >> n;\n    cout << n\
  ...
  verifiedWith: []
documentation_of: test/onlinejudge.u-aizu.ac.jp/Prime_Factorization.0.test.cpp
layout: document
redirect_from:
- /verify/test/onlinejudge.u-aizu.ac.jp/Prime_Factorization.0.test.cpp
- /verify/test/onlinejudge.u-aizu.ac.jp/Prime_Factorization.0.test.cpp.html
