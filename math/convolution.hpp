#ifndef PWMTREE_FFT_HPP
#define PWMTREE_FFT_HPP 1

#include "../template.hpp"
#include "modint.hpp"

template <class mint> void fft(vector<mint> &a, mint wn) {
    ll n = a.size(), m = n >> 1;
    vector<mint> b(n);
...
template <class mint, ll ROOT> vector<mint> convolution_friendly(vector<mint> a, vector<mint> b) {
